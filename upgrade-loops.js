/*  EJERCICIO JS LOOPS -   Iteración #1: Usa includes
...
Puedes usar este array para probar tu función:*/  TERMINAR
...
function evaluation() {
    for (let i = 0; i < alumns.length; i++) {
        if (alumns[i].isAproved("true, true")) {
...
for (const key in alien) {
    console.log("Los datos del alienígena " + key + " son: " + alien[key]);
